...
LB_lambda_cpp <- function(theta, lambda, n_sources, n_isotopes, beta_prior, concentrationmeans, sourcemeans, correctionmeans, corrsds, sourcesds, y) {
    .Call(`_simmr_LB_lambda_cpp`, theta, lambda, n_sources, n_isotopes, beta_prior, concentrationmeans, sourcemeans, correctionmeans, corrsds, sourcesds, y)
}
