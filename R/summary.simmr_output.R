...
#' 
#' # Summarise 
#' simmr_1 %>% summary() # This outputs all the summaries 
#' simmr_1 %>% summary(type='diagnostics') # Just the diagnostics
#' ans = simmr_1 %>% summary(type=c('quantiles','statistics')) # Store the output in an object
#' @export
