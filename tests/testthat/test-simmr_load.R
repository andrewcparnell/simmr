...
test_that('group example', {
  ...
  expect_identical(class(simmr_groups$source_means), 'matrix')
  expect_identical(class(simmr_groups$source_sds), 'matrix')
  expect_identical(class(simmr_groups$correction_means), 'matrix')
  expect_identical(class(simmr_groups$correction_sds), 'matrix')
  expect_identical(class(simmr_groups$concentration_means), 'matrix')
  expect_identical(class(simmr_groups$group), c('ordered', 'factor'))
  expect_identical(class(simmr_groups$group_int), c('integer'))
})
