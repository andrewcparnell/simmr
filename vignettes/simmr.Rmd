...
tl;dr see the [Quick Start](https://cran.r-project.org/web/packages/simmr/vignettes/quick_start.html) guide
...
The backquotes arund the 1 are required above because they specify which group (the first). We can thus find the probability that the posterior dietary proportion for Zostera is bigger than for Grass:
